            ...
            <div class="service-item rounded h-100 p-5">
              <div class="align-items-center mb-4">
                <div class="">
                  <img
                    class="img-fluid mb-3"
                    src="${pageContext.request.contextPath}/img/contoh-agenda-4.jpg"
                    alt=""
                  />
                </div>
                <h4 class="mb-0">Yakin Puasa Kita Mencapai Targetnya</h4>
              </div>
              <p class="mb-4">
                Kajian rabu pagi, 24 Mei 2023 Kajian muslimah, terbuka untuk
                umum Bersama KH. Ahmad Kosasih, MA
              </p>
              <a class="btn btn-light px-3" href="/agenda-detail3"
                >Lanjut Baca</a
              >
            </div>
          </div>
            ...
            <div class="service-item rounded h-100 p-5">
              <div class="align-items-center mb-4">
                <div class="">
                  <img
                    class="img-fluid mb-3"
                    src="${pageContext.request.contextPath}/img/contoh-agenda-5.jpg"
                    alt=""
                  />
                </div>
                <h4 class="mb-0">Virus Jahiliyah</h4>
              </div>
              <p class="mb-4">
                Kajian sabtu pagi, 20 mei 2023 Kajian muslimah, terbuka untuk
                umum Bersama Ustadzah Wiwin Habibah
              </p>
              <a class="btn btn-light px-3" href="/agenda-detail4"
                >Lanjut Baca</a
              >
            </div>
          </div>
            ...
            <div class="service-item rounded h-100 p-5">
              <div class="align-items-center mb-4">
                <div class="">
                  <img
                    class="img-fluid mb-3"
                    src="${pageContext.request.contextPath}/img/contoh-agenda-6.jpg"
                    alt=""
                  />
                </div>
                <h4 class="mb-0">Yang Bakhil dan Yang Dermawan</h4>
              </div>
              <p class="mb-4">
                Kajian kamis pagi, 18 Mei 2023 Kajian muslimah, terbuka untuk
                umum Bersama Ustadz Ruslan Nurhadi, Lc
              </p>
              <a class="btn btn-light px-3" href="/agenda-detail5"
                >Lanjut Baca</a
              >
            </div>
          </div>
