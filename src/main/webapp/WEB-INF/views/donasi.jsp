...
<head>
  <meta charset="utf-8" />
  <title>Donasi | Masjid Alumni IPB</title>
...
>
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
      ...
      <a href="/donasi" class="nav-item nav-link active">Donasi</a>
...
<!-- Navbar End -->
  ...
  <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container py-5 text-center">
      <h1 class="display-4 animated slideInDown mb-4 text-white">Donasi</h1>
    </div>
  </div>
  <!-- Page Header End -->
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div class="team-item rounded">
            <div class="text-center p-4">
              <h5>7074 13 6642</h5>
              <span>Operasional dan Kegiatan Masjid</span> <br>
              <span>A.N. DKM Masjid Alumni IPB</span>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div class="team-item rounded">
            <div class="text-center p-4">
              <h5>7074 13 5948</h5>
              <span>Infak dan Shodaqoh</span> <br>
              <span>A.N. LAZISWAF Masjid Alumni IPB</span>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div class="team-item rounded">
            <div class="text-center p-4">
              <h5>7733 66 5577</h5>
              <span>Zakat</span> <br>
              <span>A.N. UPZ Masjid Alumni IPB</span>
            </div>
          </div>
        </div>
      </div>
      <p align="justify">
        Kami mengucapkan terima kasih yang tak terhingga atas sumbangan berharga yang Anda berikan melalui halaman
        donasi web masjid kami. Donasi Anda telah memberikan dukungan yang sangat penting bagi kami dalam menjalankan
        kegiatan dan memperbaiki fasilitas di masjid. Semoga Allah SWT membalas kebaikan Anda dengan berlipat ganda dan
        senantiasa memberkahi Anda dalam segala hal.
      </p>
    </div>
  </div>
  <!-- Service End -->
